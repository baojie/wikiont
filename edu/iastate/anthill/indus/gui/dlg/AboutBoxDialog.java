package edu.iastate.anthill.indus.gui.dlg;
...
import edu.iastate.anthill.utils.gui.GUIUtils;
import edu.iastate.anthill.utils.gui.LabelledItemPanel;
...
{
    static String info = "<html>" +
        "<font color=\"#FF0099\"><b>" +
        "INDUS Ontology Editor</b></font><br>Version 1.0.1<br>" +
        "<br><b>Jie Bao</b><br>April 2004<br>" +
    ...
    public AboutBoxDialog(JFrame frame)
    {
        super(frame);
        createGUI();
    }
